...
const LinksCell: React.FC<CustomCellProps> = (props) => {
  ...
  <span className={baseClass}>
    ...
    <span className={siteClass} data-tooltip-id="tooltip-links" data-tooltip-content="Ссылка на сайт">
      {/* Globe */}
    ...
    <span className={ticketsClass} data-tooltip-id="tooltip-links" data-tooltip-content="Ссылка на билеты">
      {/* Tickets */}
    ...
    <span className={telegramClass} data-tooltip-id="tooltip-links" data-tooltip-content="Групповой Telegram чат">
      {/* Telegram */}
